...
#SBATCH --gres=gpu:1
#SBATCH --time=4:00:00
#SBATCH --job-name=cfact_{localization_type}_{run_id}
...
python finetuning_scripts/localized_finetuning_script_counterfact_sequential.py --config_path={os.path.join(save_dir, "config.json")}
"""
